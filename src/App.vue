...
const categories = ref([
  {
    title: "Focus",
    categoryDescription: "Music to help you concentrate.",
    playlists: [
      {
        name: "Peaceful Piano",
        playlistImg:
...
const playlists = ref([
  ...
  },
  {
    name: "lofi beats",
    playlistImg:
      "https://i.scdn.co/image/ab67706f00000002c8114f56f99e3a37159595f6",
    description:
      "Fly as a kite with beats to chill, relax, study, code, focus, and sleep... 🪁",
  },
  {
    name: "Jazz in the Background",
    playlistImg:
      "https://i.scdn.co/image/ab67706f00000002c7059110f5a17c6a5c353e2a",
    description: "Soft jazz for all your activities.",
  },
  {
    name: "Deep Focus",
...
<template>
  <!-- <header>
    <nav>
      <RouterLink to="/" class="text-indigo-600">Home </RouterLink>
  ...
  <div class="flex h-[130vh]">
    ...
    <!-- main right side -->
    <main class="w-screen bg-spotifyBG">
      <Header></Header>
      <div class="px-8 py-6 text-white border">
        <div
