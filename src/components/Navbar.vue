  ...
  <div class="bg-black py-6 min-w-[241px]">
    <div class="fixed">
      ...
      <div class="px-6 text-gray-400">
          ...
          <ul class="w-full flex flex-col space-y-4">
            ...
            <li class="list-none">
              ...
              >
                ...
                <h1 class="ml-4 font-semibold">Your Library</h1>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="flex items-center mt-10">
          <ul class="w-full flex flex-col space-y-4">
            <li class="list-none">
              <a
                href="#"
                class="group flex items-center font-semibold text-gray-400 hover:text-white ease-in duration-200"
              >
                <div
                  class="h-6 w-6 bg-gray-400 rounded-[1px] ease-in duration-200 text-black flex justify-center items-center group-hover:bg-white"
                >
                  +
                </div>
                <h1 class="ml-4 font-semibold">Create Playlist</h1>
              </a>
            </li>
            ...
            <li class="list-none">
              <a
                href="#"
                class="flex items-center font-semibold text-gray-400 hover:text-white ease-in duration-200 group"
              >
                <div
                  class="h-6 w-6 rounded-lg ease-in duration-200 opacity-80 bg-gray-400 group-hover:bg-white group-hover:opacity-100"
                >
                  <img
                ...
                <h1 class="ml-4 font-semibold">Liked Songs</h1>
              </a>
            </li>
          </ul>
        </div>
        ...
        <!-- User PLaylist -->
        <div class="border-t-[0.2px] border-gray-800 mt-4">
          <ul>
            <li>
              <a href="#">
                <h1 class="py-3 font-semibold hover:text-white cursor-default">
                  My Playlist #1
                </h1>
              </a>
            </li>
